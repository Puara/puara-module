...
This [repository](https://github.com/Puara/puara-module-templates) contains several templates to be used as a base to create devices that can be controlled over the network.
